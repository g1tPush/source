...
let requestBody: any;
let counter = 0;
let acceptLanguageHeader: any;
const server = setupServer(
  rest.post<RequestParams>("/api/1.0/users", async (req, res, ctx) => {
...
describe("Sign Up Page", () => {
  ...
  describe("Interactions", () => {
    ...
    let usernameInput: HTMLButtonElement;
  ...
  describe("Internalization", () => {
    let turkishToggle: HTMLSpanElement;
    let englishToggle: HTMLSpanElement;
    let passwordInput: HTMLInputElement;
    let passwordRepeatInput: HTMLInputElement;
    ...
    const setup = () => {
      ...
      turkishToggle = screen.getByTitle("Russian");
